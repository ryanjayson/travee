  ...
  try {
    ...
    if (flightDetailsList.length > 0) {
      ...
      return {
        ...
        departureDate: (f.departureDate && new Date(f.departureDate).getTime() > 0) ? f.departureDate : null,
        arrivalDate: (f.arrivalDate && new Date(f.arrivalDate).getTime() > 0) ? f.arrivalDate : null,
    ...
    if (id) {
      ...
      await activity.update((a) => {
        ...
        Object.assign(a, {
          ...
          planType: activityData.planType ?? null,
          website: activityData.website ?? null,
          bookingReference: activityData.bookingReference ?? null,
          contactName: activityData.contactName ?? null,
          contactNumber: activityData.contactNumber ?? null,
      ...
      if (existingDetails.length > 0) {
        await existingDetails[0].update((f) => {
          Object.assign(f, {
            ...
            departureDate: activityData.flightDetails.departureDate ? new Date(activityData.flightDetails.departureDate) : null,
